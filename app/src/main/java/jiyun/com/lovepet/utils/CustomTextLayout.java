...
public class CustomTextLayout extends RelativeLayout {
    ...
    public CustomTextLayout setLeftTv(String tvTxt, String tvColor) {
    ...
    //设置右边文字
    public CustomTextLayout setRightTv(String tvTxt, String tvColor) {
    ...
    //设置中间文字
    public CustomTextLayout setCenterTv(String tvTxt, String tvColor) {
    ...
    //代码设置左上文字颜色
    public CustomTextLayout setLeftTopTv(String tvStr, String tvColor) {
    ...
    //代码设置左下文字颜色
    public CustomTextLayout setLeftBottomTv(String tvStr, String tvColor) {
    ...
    //代码设置布局背景颜色
    public CustomTextLayout setCustomTvBackground(String strColor) {
        CustomTextLayout.this.setBackgroundColor(Color.parseColor(strColor));
        return this;
    }

    //代码设置左边图片
    public CustomTextLayout setLeftImg(Drawable icRes) {
        leftImgRes = icRes;
        if (leftIV == null) {
            initLeftImg();
        } else {
    ...
    //代码设置右边图片
    public CustomTextLayout setRightImg(Drawable icRes) {
        rightImgRes = icRes;
        if (rightIV == null) {
            initRightImg();
        } else {
    ...
    //代码设置右边的图片2
    public CustomTextLayout setRightTwoImg(Drawable icRes) {
    ...
    //设置下划线
    public CustomTextLayout setBottomLine(String color) {
