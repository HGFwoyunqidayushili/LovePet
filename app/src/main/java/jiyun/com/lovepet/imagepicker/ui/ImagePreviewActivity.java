package jiyun.com.lovepet.imagepicker.ui;
...
import jiyun.com.lovepet.imagepicker.ImagePicker;
import jiyun.com.lovepet.imagepicker.Utils;
import jiyun.com.lovepet.imagepicker.adapter.ImagePageAdapter;
import jiyun.com.lovepet.imagepicker.bean.ImageItem;
import jiyun.com.lovepet.imagepicker.view.SuperCheckBox;
import jiyun.com.lovepet.imagepicker.view.ViewPagerFixed;

public class ImagePreviewActivity extends ImageBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isOrigin = getIntent().getBooleanExtra(ImagePreviewActivity.ISORIGIN,
				false);
		mCurrentPosition = getIntent().getIntExtra(
				ImagePicker.EXTRA_SELECTED_IMAGE_POSITION, 0);
		...
		RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) topBar
				.getLayoutParams();
		...
		mCbCheck.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mCbCheck.isChecked()
						&& selectedImages.size() >= selectLimit) {
					Toast.makeText(
							ImagePreviewActivity.this,
							ImagePreviewActivity.this.getString(
									R.string.select_limit, selectLimit),
							Toast.LENGTH_SHORT).show();
					mCbCheck.setChecked(false);
				} else {
					imagePicker.addSelectedImageItem(mCurrentPosition,
							imageItem, mCbCheck.isChecked());
				}
			}
		});
	}
