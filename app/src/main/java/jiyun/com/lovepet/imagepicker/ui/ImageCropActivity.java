...
import jiyun.com.lovepet.imagepicker.view.CropImageView;

public class ImageCropActivity extends ImageBaseActivity implements
		View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
	...
	public void onClick(View v) {
		...
		if (id == R.id.btn_back) {
			...
			mCropImageView.saveBitmapToFile(
					imagePicker.getCropCacheFolder(this), mOutputX, mOutputY,
					mIsSaveRectangle);
		}
	}
	...
	public void onBitmapSaveSuccess(File file) {
		// Toast.makeText(ImageCropActivity.this, "裁剪成功:" +
