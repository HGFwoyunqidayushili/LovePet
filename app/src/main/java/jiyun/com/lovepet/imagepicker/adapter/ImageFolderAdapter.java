...
public class ImageFolderAdapter extends BaseAdapter {
	...
	public int getItemViewHeight() {
		View itemView = mInflater.inflate(R.layout.adapter_folder_list_item,
				null);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_folder_list_item,
					parent, false);
		...
		holder.imageCount.setText(mActivity.getString(
				R.string.folder_image_count, folder.images.size()));
		imagePicker.getImageLoader().displayImage(mActivity, folder.cover.path,
