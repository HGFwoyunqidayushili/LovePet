...
import jiyun.com.lovepet.imagepicker.ImageDataSource;
import jiyun.com.lovepet.imagepicker.ImagePicker;
import jiyun.com.lovepet.imagepicker.Utils;
import jiyun.com.lovepet.imagepicker.adapter.ImageFolderAdapter;
import jiyun.com.lovepet.imagepicker.adapter.ImageGridAdapter;
import jiyun.com.lovepet.imagepicker.bean.ImageFolder;
...
public class ImageGridActivity extends ImageBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent() != null) {
			Boolean isPicture = getIntent().getBooleanExtra("isPicture", false);
			if (isPicture) {
	...
	private void createPopupFolderList(int width, int height) {
		...
		int realHeight = mImageFolderAdapter.getItemViewHeight()
				* mImageFolderAdapter.getCount();
		...
		if (data != null) {
			...
			if (resultCode == RESULT_OK
				...
				imageItem.path = imagePicker.getTakeImageFile()
						.getAbsolutePath();
				imageItem.width = imagePicker.getFocusWidth();
				imageItem.height = imagePicker.getFocusHeight();
				imageItem.name = imagePicker.getTakeImageFile().getName();
				imageItem.size = getFileSize(imagePicker.getTakeImageFile());
				imagePicker.clearSelectedImages();
